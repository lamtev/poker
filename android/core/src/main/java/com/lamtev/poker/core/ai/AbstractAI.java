...
public abstract class AbstractAI implements AI {
    ...
    final public void rivalsBecomeKnown(List<Rival> rivals) {
        for (Rival it : rivals) {
            this.rivals.put(it.id, it);
        }
    }

    @Override
    @Deprecated
    final public void holeCardsDealt(Map<String, List<Card>> playerIdToCards) {
        throw new RuntimeException();
    }

    @Override
    @Deprecated
    final public void playerShowedDown(String playerId, PokerHand hand) {
        throw new RuntimeException();
    }
